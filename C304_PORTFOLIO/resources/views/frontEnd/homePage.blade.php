  ...
  <div class="custom-hero">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <h1 class="hero-heading">J.P. Espergoza &mdash; Junior Developer</h1>
          <div  class="line js-line mx-auto mb-3 my-3"></div>
          <p class="sub-text">I'm a 3rd Computer Science student focused on learning, building, functional, and user-friendly projects. Feel free to explore my projects that I've developed through college. </p>
        </div>
      </div>
    </div>
  </div>
